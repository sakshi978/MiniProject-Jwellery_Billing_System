...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    f1.mainloop()
    root.mainloop()
def b_ok_fp_f(enter_pass):
    if image_steg.password == enter_pass.get():
        root1.destroy()
        pppp()
    else:
...
lb_fp = Label(root1, text='Enter your password', bg="#c93838", padx=50, pady=10, fg="white",
              font="Verdana 30 bold").place(x=160, y=100)
e1_fp = Entry(root1, width=20, textvariable=enter_pass, font="Verdana 25 bold",show = "*").place(x=200, y=250)
b_ok_fp_f = partial(b_ok_fp_f, enter_pass)
b_ok_fp = Button(root1, text="OK", bg="black", fg="white", padx=20, pady=10, font="Verdana 20 bold",
                 command=b_ok_fp_f).place(x=400,y=350)
'''l_made1=Label(root1, text='  Vasudha Shah ', bg="#da9833", padx=10, pady=9, fg="black",
              font="Verdana 10 bold").place(x=750, y=500)
l_made2=Label(root1, text='Shreya Tendulkar', bg="#da9833", padx=10, pady=9, fg="black",
              font="Verdana 10 bold").place(x=750, y=540)
l_made3=Label(root1, text='Sakshi Joshi', bg="#0b032d", padx=10, pady=9, fg="white",
              font="Verdana 10 bold").place(x=750, y=550)'''
root1.mainloop()