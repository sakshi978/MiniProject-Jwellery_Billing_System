...
l_made1=Label(root1, text='Sakshi Joshi', bg="#da9833", padx=10, pady=9, fg="black",
              font="Verdana 10 bold").place(x=750, y=460)
l_made2=Label(root1, text='Kartik Kadwane', bg="#da9833", padx=10, pady=9, fg="black",
              font="Verdana 10 bold").place(x=750, y=500)
l_made2=Label(root1, text='Naman Bardiya', bg="#da9833", padx=10, pady=9, fg="black",
